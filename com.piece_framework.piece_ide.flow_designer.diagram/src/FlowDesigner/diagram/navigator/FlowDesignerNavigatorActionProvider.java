 ...
 * @generated
 */
public class FlowDesignerNavigatorActionProvider extends CommonActionProvider {
    ...
    private class OpenDiagramAction extends Action {
        ...
        public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
            super(
                    FlowDesigner.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
        ...
        public final void selectionChanged(IStructuredSelection selection) {
            ...
            if (selection.size() == 1) {
                ...
                if (selectedElement instanceof FlowDesigner.diagram.navigator.FlowDesignerNavigatorItem) {
                    selectedElement = ((FlowDesigner.diagram.navigator.FlowDesignerNavigatorItem) selectedElement)
                            .getView();
